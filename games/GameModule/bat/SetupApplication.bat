...
:: Android packaging
set AND_CERT_NAME="GameModule"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\GameModule.p12
...
set IOS_PROVISION=cert\GameModule.mobileprovision
...
set APP_ID=air.GameModule

:: Output packages
set DIST_PATH=dist
set DIST_NAME=GameModule
