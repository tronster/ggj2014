package 
{
	...
	public class Main extends StarlingCitrusEngine 
	{
		...
		override public function handleStarlingReady():void
		{
			...
			levelData 	= LevelMaker.create( Config.LEVEL_DATA_STRAIGHT, cats, spawns, "Our neighbor's dogs smell our sushi!" );			
			...
			levelData 	= LevelMaker.create( Config.LEVEL_DATA_STRAIGHT, cats, spawns, "Oh no, they're back with more!" );			
			levelData.citrusSpriteNum = 0;
			levels.push( levelData );
			...
			levelData 	= LevelMaker.create( Config.LEVEL_DATA_ONEBEND, cats, spawns, "Even in puffy's yard the dogs have found us." );			
			...
			levelData 	= LevelMaker.create( Config.LEVEL_DATA_ONEBENDLONG, cats, spawns, "No matter where we go, the dogs follow." );			
			...
			levelData 	= LevelMaker.create( Config.LEVEL_DATA_ONEBENDLONG, cats, spawns, "Keep fighting warrior cats!" );			
			levelData.citrusSpriteNum = 2;
			levels.push( levelData );
			...
			levelData 	= LevelMaker.create( Config.LEVEL_DATA_TWOBEND, cats, spawns, "Our last stand, Katseye!!!!!!" );			
