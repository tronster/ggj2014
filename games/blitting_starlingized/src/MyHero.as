package  
{
	 ...
	 */	
	public class MyHero extends Box2DPhysicsObject
	{
		//properties
		/**
		...
		override public function update(timeDelta:Number):void
		{
			...
			/* //output all current input actions
			var str:String = new String();
			var actions:Vector.<InputAction> = _ce.input.getActions( -1, null, -1);
			for (var i:int = 0; i < actions.length; i++)
			{
				str += actions[i].name + ", ";
			}
			trace("Contained Actions: " + str);*/
		...
		protected function updateAnimation():void {
			...
			if (_hurt)
				...
				_animation = "blue_burst_";
				
			else {
				
				if (walkingSpeed < -acceleration) {
					_inverted = true;
					_animation = "blue_hit_";
					...
					_animation = "big_eradium_explosion_";
			}
