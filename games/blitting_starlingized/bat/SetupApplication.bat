...
:: Android packaging
set AND_CERT_NAME="blitting_starlingized"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\blittingstarlingized.p12
...
set IOS_PROVISION=cert\blittingstarlingized.mobileprovision
...
set APP_ID=air.blittingstarlingized

:: Output packages
set DIST_PATH=dist
set DIST_NAME=blittingstarlingized
